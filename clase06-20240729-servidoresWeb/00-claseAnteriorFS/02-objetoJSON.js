...
let heroesDesdeArchivo=JSON.parse(fs.readFileSync(rutaArchivo, {encoding: "utf-8"}))
console.log(heroesDesdeArchivo)
console.log(typeof heroesDesdeArchivo)
// console.log(heroes)
// console.log(typeof heroes)
// console.log(heroes[0].alias)
console.log(heroesDesdeArchivo[0].alias)