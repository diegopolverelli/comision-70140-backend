...
import { heroesModelo } from "./src/dao/models/heroesModelo.js";
import { villanosModelo } from "./src/dao/models/villanosModelo.js";
...
const creaData = async () => {
    ...
    await villanosModelo.deleteMany({})
    await villanosModelo.insertMany(villanos)
